      ...
      <div className="footer-row">
        ...
        <div className="footer-links">
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            ...
            <a href="/privacy-policy.pdf" target="_blank" className="text-link" style={{ fontSize: '18px', lineHeight: '140%', color: '#919191', marginTop: '16px', display: 'inline-block', width: 'fit-content' }}>Privacy Policy</a>
